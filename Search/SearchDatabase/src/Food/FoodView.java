 ...
 * @author yessi
 */
public class FoodView extends GridPane{
    ...
    public FoodView() 
    {
        ...
        this.addRow(1, nameLabel, nameText);
        this.addRow(2, update);
    ...
    public void updateFoodView ()
    {
        ...
        this.addRow(1, getNameLabel(), getNameText());
        this.addRow(2, update);
        this.addRow(3, getGroupLabel(), getGroupText());
        this.addRow(4, iv, Nutrition_Facts);
    }
