...
public class EmailController {
    ...
    static EmailView View = new EmailView();
    ...
    public static EmailView getView() {
        return View;
    }
    
    public void setupHandlers()
    {
       View.getSendButton().setOnAction(new EventHandler<ActionEvent> ()
       {
           @Override
		...
		String port = "465";
		String mailFrom = View.getMailFromField().getText();
		String password = View.getPasswordField().getText();

		// message info
		String mailTo = View.getMailFromField().getText();
		String subject = View.getSubjectField().getText();
		String message = View.getMessageField().getText();

		// attachments
		String[] attachFiles = new String[1];
		attachFiles[0] = "Nutrition.pdf";
		
		//attachFiles[2] = "e:/Test/Video.mp4";
		
		// CC emails
		String[] ccEmails ={View.getCcEmailField().getText()};
                if(View.getCcEmailField().getText() != null){
                    try {
