...
public class TabManager extends HBox{
    ...
    private Environment.Controllers.Test test_Controller = new Environment.Controllers.Test();
    ...
    public TabManager(BorderPane root) {
        this.mainMenu = new String[]{"Home", "Diet", "About", "Admin"};

        //Sub Tabs (Title, CSS Id, Controller View)
        this.subMenus = new Object[][][]{
            /*Home*/
            {
                {"Home Page" ,"homePage", test_Controller.getView()},
            ...
            /*About*/
            {
                {"l" ,"tr", test_Controller.getView()}
            },
            /*Admin*/
            {
                {"jk" ,"jg", test_Controller.getView()}
            },
        };
