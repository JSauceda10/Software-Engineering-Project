...
// Top Part is the nutrients panel
	...
	foodCategories.add( new Category("3","Fruits",0));
        foodCategories.add( new Category("4","Oil and Sweets",0));
...
//            "Beef");
    ...
    public ObservableList<PieChart.Data> getChartData() 
    {
        ...
        ObservableList<PieChart.Data> pieChartData =
                ...
                new PieChart.Data("Vegtables-01", 1),
                new PieChart.Data("Grains-02", 1),
	        new PieChart.Data("Fruits-03", 1),
                new PieChart.Data("Oils-04", 1),
                new PieChart.Data("Dairy-05", 1),
                new PieChart.Data("Meats-06", 1));
                return pieChartData;
    }
